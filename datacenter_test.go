...
func TestDatacenterCreateOrUpdate(t *testing.T) {
	...
	obj := Datacenter{
		...
		DatacenterConfig: &DatacenterConfig{
			...
			RepoURLRoot:                           "https://repo.metalsoft.io",
			RepoURLRootQuarantineNetwork:          "https://repo.metalsoft.io",
