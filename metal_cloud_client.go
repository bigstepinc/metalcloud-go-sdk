...
type MetalCloudClient interface {
	...
	ClusterAppVMWareVCF(clusterID int, decryptCredentials bool) (*AppVMWareVCF, error)
	//ClusterAppVMWareVCFByLabel cluster
	ClusterAppVMWareVCFByLabel(clusterLabel string, decryptCredentials bool) (*AppVMWareVCF, error)
	...
	ClusterAppKubernetesEKSA(clusterID int, decryptCredentials bool) (*AppKubernetesEKSA, error)
	//ClusterAppKubernetesEKSAByLabel cluster
	ClusterAppKubernetesEKSAByLabel(clusterLabel string, decryptCredentials bool) (*AppKubernetesEKSA, error)
	...
	Subnets(infrastructure_id int) (*map[string]Subnet, error)
