...
type MetalCloudClient interface {
	...
	SwitchDeviceControllerCreate(switchDevice SwitchDevice, bOverwriteWithHostnameFromFetchedSwitch bool) (*map[int]SwitchDevice, error)
	...
	// SwitchDeviceUpdate updates an existing switch configuration
	SwitchDeviceControllerUpdate(networkEquipmentControllerID int, networkEquipmentControllerData map[int]string) (*SwitchDeviceController, error)
