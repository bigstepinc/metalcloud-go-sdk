...
func TestProvisionedSharedDriveUnmarshalTest(t *testing.T) {
	...
	Expect(i.SharedDriveCredentials.ISCSI.TargetIQN).To(Equal("iqn.2013-01.io.metalsoft:storage.91nqwgd.4lys6bq.iel1v3k"))
}
...
func TestSharedDriveCreateOrUpdate(t *testing.T) {
	...
	obj := SharedDrive{
		...
		SharedDriveSubdomain:              "csivolumename.test-kube-csi.7.metalsoft.io",
