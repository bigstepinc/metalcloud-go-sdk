...
func (c *Client) InstanceArrayInterfaceCreate(instanceArrayID int) (*InstanceArrayInterface, error) {
	var createdObject InstanceArrayInterface

	err := c.rpcClient.CallFor(
		&createdObject,
		"instance_array_interface_create",
		instanceArrayID)
