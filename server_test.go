...
func TestServerCreateUnmanagedUnmarshal(t *testing.T) {
	RegisterTestingT(t)

	var obj ServerCreateUnmanaged

	err := json.Unmarshal([]byte(_serverUnmanagedFixture1), &obj)
	Expect(err).To(BeNil())
	Expect(obj.DatacenterName).To(Equal("sonic-qts"))
	Expect(obj.ServerSerialNumber).To(Equal("RANDOM-123"))
	Expect(len(obj.ServerInterfaces)).To(Equal(2))
	Expect(obj.ServerInterfaces[0].NetworkEquipmentIdentifierString).To(Equal("leaf-124"))
	Expect(obj.ServerInterfaces[0].ServerInterfaceMACAddress).To(Equal("aa:bb:cc:dd:00:01"))
	Expect(obj.ServerInterfaces[0].NetworkEquipmentInterfaceIdentifierString).To(Equal("Ethernet3"))
	Expect(obj.ServerInterfaces[1].NetworkEquipmentIdentifierString).To(Equal("leaf-124"))
	Expect(obj.ServerInterfaces[1].ServerInterfaceMACAddress).To(Equal("aa:bb:cc:dd:00:02"))
	Expect(obj.ServerInterfaces[1].NetworkEquipmentInterfaceIdentifierString).To(Equal("Ethernet4"))
...
const _serverUnmanagedFixture1 = "{\"datacenter_name\":\"sonic-qts\",\"server_serial_number\":\"RANDOM-123\",\"server_type_id\":9,\"server_interfaces\":[{\"server_interface_mac_address\":\"aa:bb:cc:dd:00:01\",\"network_equipment_identifier_string\":\"leaf-124\",\"network_equipment_interface_identifier_string\":\"Ethernet3\"},{\"server_interface_mac_address\":\"aa:bb:cc:dd:00:02\",\"network_equipment_identifier_string\":\"leaf-124\",\"network_equipment_interface_identifier_string\":\"Ethernet4\"}]}"
